...
export default class Driver {
  ...
  search(passenger) {
    ...
    console.log("the passenger this driver registered within constructor is: " + this.passenger.id);
    if (this.passenger) {
  ...
  pickUp() {
    ...
    this.state = "transit";
    console.log("from Driver class, Driver " + this.id + " has reached this passenger: " + this.passenger.id + " thus moving into the transit state. Checking state: " + this.state + " and going to passenger destination now: " + this.destination);
  }
  transit() {
    // this.destination = this.passenger.destination;
    // if (this.currentLocation < this.destination - this.speed) {
    ...
    console.log("from Driver class, Driver " + this.id + " is going on a trip with passenger " + this.passenger.id + "'s journey, waiting to mark complete trip... Checking state: " + this.state + " but currently still holding this destination: " + this.destination);
  }
  completed() {
